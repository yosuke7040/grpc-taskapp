...
// @generated from file rpc/task/v1/task.proto (package rpc.task.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class UncompleteTaskRequest extends Message<UncompleteTaskRequest> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UncompleteTaskRequest {
    return new UncompleteTaskRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UncompleteTaskRequest {
    return new UncompleteTaskRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UncompleteTaskRequest {
    return new UncompleteTaskRequest().fromJsonString(jsonString, options);
  }

  static equals(a: UncompleteTaskRequest | PlainMessage<UncompleteTaskRequest> | undefined, b: UncompleteTaskRequest | PlainMessage<UncompleteTaskRequest> | undefined): boolean {
...
export class UncompleteTaskResponse extends Message<UncompleteTaskResponse> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UncompleteTaskResponse {
    return new UncompleteTaskResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UncompleteTaskResponse {
    return new UncompleteTaskResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UncompleteTaskResponse {
    return new UncompleteTaskResponse().fromJsonString(jsonString, options);
  }

  static equals(a: UncompleteTaskResponse | PlainMessage<UncompleteTaskResponse> | undefined, b: UncompleteTaskResponse | PlainMessage<UncompleteTaskResponse> | undefined): boolean {
...
export class ChangeTaskNameRequest extends Message<ChangeTaskNameRequest> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ChangeTaskNameRequest {
    return new ChangeTaskNameRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ChangeTaskNameRequest {
    return new ChangeTaskNameRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ChangeTaskNameRequest {
    return new ChangeTaskNameRequest().fromJsonString(jsonString, options);
  }

  static equals(a: ChangeTaskNameRequest | PlainMessage<ChangeTaskNameRequest> | undefined, b: ChangeTaskNameRequest | PlainMessage<ChangeTaskNameRequest> | undefined): boolean {
...
export class ChangeTaskNameResponse extends Message<ChangeTaskNameResponse> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ChangeTaskNameResponse {
    return new ChangeTaskNameResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ChangeTaskNameResponse {
    return new ChangeTaskNameResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ChangeTaskNameResponse {
    return new ChangeTaskNameResponse().fromJsonString(jsonString, options);
  }

  static equals(a: ChangeTaskNameResponse | PlainMessage<ChangeTaskNameResponse> | undefined, b: ChangeTaskNameResponse | PlainMessage<ChangeTaskNameResponse> | undefined): boolean {
